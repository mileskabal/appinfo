...
+ (NSDictionary *)infoForDevice {
    ...
    NSDictionary *info = [[[NSDictionary alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:[device stringByReplacingOccurrencesOfString:@" " withString:@""] ofType:@"plist"]] autorelease];
    return info;
}
